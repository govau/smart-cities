...
export default {
    ...
    growthRate: {
        ...
        format: '0.[00]%',
        contextual: true,
        lastUpdated: 'June 2013 to 2018  -  NEW!',
    ...
    participationRateGeneral: {
        ...
        format: '0.[0]%',
        contextual: false,
        lastUpdated: 'July 2017 to June 2018  -  NEW!',
    ...
    unemploymentRateIndigenous: {
        ...
        format: '0.[00]%',
        contextual: false,
        lastUpdated: 'August 2016  -  NEW!',
        source: 'indigenous_unemployment'
    },
    unemploymentRateYouth: {
        name: 'Youth unemployment rate',
        format: '0.[00]%',
        contextual: false,
        lastUpdated: 'July 2016 to June 2018  -  NEW!',
    ...
    employmentGrowth: {
        ...
        format: '0.[00]%',
        contextual: false,
        lastUpdated: 'June 2013 to June 2018  -  NEW!',
