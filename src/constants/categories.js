...
export const CATEGORIES = [{
    ...
    subCategories: [{
        ...
        iconId: 'jobsEmployment',
        summaryIndicatorIds: ['unemploymentRateGeneral', 'employmentGrowth'],
        charts: [{
    ...
    subCategories: [{
        ...
        charts: [{
            ...
            axisTitle: '',
            description: 'This shows the proportion of households with a mortgage for which mortgage payments make up 30 per cent or more of household income.\r\nSource: ABS - Census 2016',
            ...
            axisTitle: '',
            description: 'This shows the average price over 12 months for detached dwellings.\r\nSource: CoreLogic',
        ...
        charts: [{
            ...
            axisTitle: '',
            description: 'This shows the proportion of renting households for which rent makes up 30 per cent or more of household income.\r\nSource: ABS - Census 2016',
