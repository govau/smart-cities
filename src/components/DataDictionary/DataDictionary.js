...
const DataDictionary = () => (
 ...
 <h1 className={style.title}>Data dictionary</h1>
  <ul className={style.cols2}>
   ...
   <li><Link href="#indigenous-unemployment-rate">Indigenous unemployment rate</Link></li>
  </ul>
 </div>
</section>
<section className={style.sectionWrapper}>
...
<table className={style.table}>
 <tr>
  ...
  <tr>
    <td>Office building energy efficiency rating</td>
    <td className={style.tableCell}>X</td>
    <td className={style.tableCell}>X</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<section className={style.sectionWrapper}>
 <div className={style.sectionContainer}>
  ...
  <h3 className={style.heading3}>Description</h3>
  <p className={style.paragraph}>The proportion of households for which mortgage payments make up 30 per cent or more of household income. This indicator is expressed as a percentage of the total number of households in the city.</p>
  <h3 className={style.heading3}>Rationale</h3>
  ...
  <p className={style.paragraph}>Australian Bureau of Statistics - Census of Population and Housing 2016</p>
  <h3 className={style.heading3}>Date Published</h3>
  <p className={style.paragraph}>23 October 2017</p>
  <h3 className={style.heading3}>Data Source Link</h3>
  <p className={style.paragraph}><Link href="http://www.abs.gov.au/websitedbs/D3310114.nsf/Home/Census?OpenDocument&ref=topBar">http://www.abs.gov.au/websitedbs/D3310114.nsf/Home/Census?OpenDocument&amp;ref=topBar</Link></p>
  <h3 className={style.heading3}>Data Source Geography</h3>
  <p className={style.paragraph}>GCCSA (Capital cities), LGAs (Western Sydney) and SUA (other cities) (ASGS 2016)</p>
  <h3 className={style.heading3}>Method</h3>
  <p className={style.paragraph}>Estimates were taken directly from the ABS QuickStats products at the required geography, except in the case of Western Sydney.  Western Sydney was calculated by combining estimates from the constituent LGAs.  The ABS method of calculation is the number of households where mortgage repayments were 30% or more of an imputed income measure.  The number of households are expressed as a proportion of the total number of households in an area (including those households which were renting, and excluding the small proportion of visitor only and other non-classifiable households). The nature of the income imputation means that the reported proportion may significantly overstate the true proportion.</p>
...
<section className={style.sectionWrapper}>
 <div className={style.sectionContainer}>
  ...
  <h3 className={style.heading3}>Description</h3>
  <p className={style.paragraph}>The proportion of households for which rent payments make up 30 per cent or more of household income. This indicator is expressed as a percentage of the total number of households in the city.</p>
  <h3 className={style.heading3}>Rationale</h3>
...
<section className={style.sectionWrapper}>
 <div className={style.sectionContainer}>
  <h2 className={style.heading2} id="indigenous-unemployment-rate">Indigenous unemployment rate</h2>
  <h3 className={style.heading3}>Description</h3>
  <p className={style.paragraph}>The percentage of the Aboriginal and Torres Strait Islander labour force (aged 15+) who is unemployed. A person is classified as unemployed if they are 15 years or older and identified as looking for full-time or part-time work in the Census.</p>
  <h3 className={style.heading3}>Rationale</h3>
  <p className={style.paragraph}>The unemployment rate is an indicator of the amount of spare capacity in a city’s labour market. Being unemployed also has implications for a person’s economic, social and emotional wellbeing.</p>
  <h3 className={style.heading3}>Limitations</h3>
  <p className={style.paragraph}>The Aboriginal and Torres Strait Islander unemployment rate is based on Census data and is not comparable to the other employment indicators on the Dashboard. This is due to the differences in Census and Labour Force Survey methods. Use caution when interpreting the Aboriginal and Torres Strait Islander unemployment rate as there is no adjustment for undercount or non-response.</p>
  <h3 className={style.heading3}>Data Source</h3>
  <p className={style.paragraph}>Australian Bureau of Statistics - Census of Population and Housing 2016</p>
  <h3 className={style.heading3}>Date Published</h3>
  <p className={style.paragraph}>23 October 2017</p>
  ...
  <p className={style.paragraph}>GCCSA (Capital cities), LGA (Western Sydney) and SUA (other cities) (ASGS 2016)</p>
  <h3 className={style.heading3}>Method</h3>
  <p className={style.paragraph}>Persons identifying as Aboriginal, Torres Strait Islander, or both and their labour force status is extracted from Census Tablebuilder at required geographies. Persons aged under 15 are excluded. Persons with Indigenous status Not Stated or labour force status Not Stated are excluded from the calculation.</p>
  <h3 className={style.heading3}>Unit</h3>
  <p className={style.paragraph}>Percentage</p>
  <h3 className={style.heading3}>Revision Schedule</h3>
  <p className={style.paragraph}>Five yearly</p>
